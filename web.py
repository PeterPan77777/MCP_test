...
from server import mcp  # Nur mcp importieren, Initialisierung erfolgt beim Import
...
# 4️⃣  Haupt-App ohne zusätzlichen Lifespan (Initialisierung erfolgt beim Import)
