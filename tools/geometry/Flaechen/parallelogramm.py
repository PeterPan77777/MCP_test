...
Beispiel: grundseite=["10 cm", "15 cm", "20 cm"] statt grundseite="10 cm"
...
FUNCTION_PARAM_1_DESC = "Fläche des Parallelogramms mit Flächeneinheit (z.B. '50 cm²', '0.005 m²', '5000 mm²') oder 'target' für Berechnung. BATCH: Als Teil einer Liste mit vollständigen Parametersätzen"
FUNCTION_PARAM_1_EXAMPLE = "50 cm²"

FUNCTION_PARAM_2_NAME = "grundseite"
FUNCTION_PARAM_2_DESC = "Grundseite des Parallelogramms mit Längeneinheit (z.B. '10 cm', '100 mm', '0.1 m') oder 'target' für Berechnung. BATCH: Als Teil einer Liste mit vollständigen Parametersätzen"
FUNCTION_PARAM_2_EXAMPLE = "10 cm"

FUNCTION_PARAM_3_NAME = "hoehe"
FUNCTION_PARAM_3_DESC = "Höhe des Parallelogramms mit Längeneinheit (z.B. '5 cm', '50 mm', '0.05 m') oder 'target' für Berechnung. BATCH: Als Teil einer Liste mit vollständigen Parametersätzen"
...
solve_parallelogramm(
    flaeche=['target', '60 cm²', 'target'],
    grundseite=['10 cm', '12 cm', '15 cm'],
    hoehe=['5 cm', 'target', '8 cm']
)
Dies berechnet 3 separate Parallelogramme mit jeweils einem anderen Target-Parameter.
...
PARAMETER_FLAECHE = {
    ...
    "batch_example": ["target", "60 cm²", "target"]  # NEU
}
...
PARAMETER_GRUNDSEITE = {
    ...
    "batch_example": ["10 cm", "12 cm", "15 cm"]  # NEU
}
...
PARAMETER_HOEHE = {
    ...
    "batch_example": ["5 cm", "target", "8 cm"]  # NEU
}
...
TOOL_EXAMPLES = [
    ...
    },
    {
        ...
        "input": {
            FUNCTION_PARAM_1_NAME: ["target", "60 cm²", "target"],
            FUNCTION_PARAM_2_NAME: ["10 cm", "12 cm", "15 cm"],
            FUNCTION_PARAM_3_NAME: ["5 cm", "target", "8 cm"]
        },
...
def prepare_batch_combinations(params: Dict[str, Any]) -> List[Dict[str, str]]:
    ...
    Output: [
        {'flaeche': 'target', 'grundseite': '10 cm', 'hoehe': '5 cm'},
        {'flaeche': '60 cm²', 'grundseite': '12 cm', 'hoehe': 'target'},
        {'flaeche': 'target', 'grundseite': '15 cm', 'hoehe': '8 cm'}
    ]
    """
