...
def solve_prisma(
    ...
    try:
        ...
        return {
            "error": f"Fehler in solve_prisma: {str(e)}",
            "type": type(e).__name__
        }

def _solve_single_prisma(
    volumen: str,
    grundflaeche: str,
    hoehe: str
) -> Dict:
...
def calculate(volumen: str, grundflaeche: str, hoehe: str) -> Dict:
    ...
    return solve_prisma(volumen=volumen, grundflaeche=grundflaeche, hoehe=hoehe)
